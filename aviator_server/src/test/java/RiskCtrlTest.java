...
import com.zzj.rule.server.common.enums.RiskCtrlCheckResultEnum;
...
public class RiskCtrlTest {
    ...
    public void executeExpression() {
        ...
        // 取hermes规则
        Map<String, RuleContext> functionName2ruleCtx = null;
        try {
            functionName2ruleCtx = getFunctionName2ruleCtx(invocationInfo);
        } catch (Exception e) {
            log.error("getFunctionName2ruleCtx", e);
            throw new RpcException(FormErrorEnum.RISK_CTRL_QUERY_HERMES_RULE_FAIL);
        }
